            ...
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-header">
                        <div>
                            <h1 class="card-title mb-1">添加 AI 智能体</h1>
                            <div class="text-secondary">维护 /ai 页面展示的智能体名称、链接、描述与标签。</div>
                        </div>
                    </div>
                    ...
                    <form action="{{ route('ai.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input id="path" type="url" class="form-control @error('path') is-invalid @enderror" name="path" value="{{ old('path') }}" placeholder="https://">
                                @error('path')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                <label class="form-label" for="image">图片</label>
